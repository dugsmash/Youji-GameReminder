...
| 🌫️ **亚克力材质** | Windows 11 使用系统级 Acrylic；Win10 自动回退"透明窗口 + CSS 高斯模糊" |
...
```
GameRemainder/
├── main.cjs               # Electron 主进程：悬浮/亚克力/托盘/原子写盘/冒烟与截图模式
├── preload.cjs            # contextBridge 安全 IPC
├── renderer/
│   ├── index.html         # 页面骨架（自绘标题栏/侧栏/内容区）
│   ├── css/app.css        # 亚克力友好的半透明深色主题
│   └── js/
