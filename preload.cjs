...
contextBridge.exposeInMainWorld('api', {
  ...
  winGetBounds: () => ipcRenderer.invoke('window:getBounds'),
  winSetBounds: (b) => ipcRenderer.invoke('window:setBounds', b),
  winResizeStart: (dir) => ipcRenderer.invoke('window:resize:start', dir),
  winResizeMove: () => ipcRenderer.invoke('window:resize:move'),
  winResizeEnd: () => ipcRenderer.invoke('window:resize:end'),
